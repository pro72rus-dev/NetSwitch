...
![Version](https://img.shields.io/badge/version-1.0.3-0078D4?style=for-the-badge)
...
Нажмите `End` — интернет выключен. Нажмите ещё раз — включён.
...
| Действие | Как |
|:---------|:----|
| 🔌 Вкл/Выкл интернет | `End` (или настроенная комбинация) |
