...
_strings = {
    'en': {
        ...
        'filter_stopped': 'Filter stopped',
        'add_app': '+ Add',
        'remove_app': '- Remove',
        'whitelist_count': 'apps',
        'filter_failed': 'Filter failed to start\nRun as Administrator',
    },
    'ru': {
        'status': 'СТАТУС',
        ...
        'mode_label': 'РЕЖИМ',
        'mode_adapters': 'Все',
        'mode_whitelist': 'Вайтлист',
        'whitelist_empty': 'Вайтлист пуст',
        'filter_started': 'Фильтр запущен',
        'filter_stopped': 'Фильтр остановлен',
        'add_app': '+ Добавить',
        'remove_app': '- Убрать',
        'whitelist_count': 'прил.',
        'filter_failed': 'Не удалось запустить фильтр\nЗапустите от имени Администратора',
        'whitelist_add': 'Добавлено в вайтлист',
        'whitelist_remove': 'Убрано из вайтлиста',
        'whitelist_empty_hint': 'Нажмите + Добавить чтобы добавить',
